...
export default function HistoryPage(props) {
  const { historySearch, setHistorySearch, startDate, setStartDate, endDate, setEndDate, role, branchFilter, setBranchFilter, salesHistory, currentUser, exportExcel, setCancelBillNo, cancelBillNo, cancelPassword, setCancelPassword, approveCancelBill, reprintBill } = props;
