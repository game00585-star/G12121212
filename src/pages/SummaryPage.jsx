...
export default function SummaryPage(props) {
  ...
  return <div style={cardStyle}>
    <div className="page-head"><div><h2>สรุปยอดขาย</h2><p>แสดง {pageRows.length} จาก {summaryResult.length} รายการ</p></div><div className="summary-actions"><button style={saveBtn} onClick={exportSummaryExcel}>Export Summary Excel</button><button style={printBtn} onClick={exportDailySummaryPdf}>PDF รายวัน</button><button style={printBtn} onClick={printDailySummary}>ปริ้นรายวัน</button></div></div>
