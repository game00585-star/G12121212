...
import { cardStyle, inputStyle, saveBtn } from "../styles/uiStyles";
import { fieldNames, getField } from "../utils/salesSummary";

const PAGE_SIZE = 30;

export default function SummaryPage(props) {
  const { summaryStartDate, setSummaryStartDate, summaryEndDate, setSummaryEndDate, role, summaryBranch, setSummaryBranch, salesHistory, exportSummaryExcel, summaryResult } = props;
  ...
  return <div style={cardStyle}>
    <div className="page-head"><div><h2>สรุปยอดขาย</h2><p>แสดง {pageRows.length} จาก {summaryResult.length} รายการ</p></div><button style={saveBtn} onClick={exportSummaryExcel}>Export Summary Excel</button></div>
