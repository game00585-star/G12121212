export const DEFAULT_POS_CATEGORIES = [
  ...
  { id: "beef-pork-frozen", name: "เนื้อวัว/เนื้อหมู แช่แข็ง", icon: "🧊", image: "/category-assets/beef-pork-frozen.png", matchText: "เนื้อวัว/เนื้อหมู แช่แข็ง" },
  { id: "egg", name: "ไข่ ไข่แปรรูป", icon: "🥚", matchText: "ไข่ ไข่แปรรูป" },
  { id: "duck-chicken-frozen", name: "เนื้อเป็ด/เนื้อไก่ แช่แข็ง", icon: "❄️", image: "/category-assets/duck-chicken-frozen.png", matchText: "เนื้อเป็ด/เนื้อไก่ แช่แข็ง" },
  ...
  { id: "frozen-food", name: "อาหารแช่แข็ง", icon: "🧊", image: "/category-assets/frozen-food.png", matchText: "อาหารแช่แข็ง" },
  { id: "bulk-frozen-pork", name: "หมูแช่แข็งเทขาย", icon: "🍖", matchText: "หมูแช่แข็งเทขาย" },
  { id: "chilled-food", name: "อาหารแช่เย็น", icon: "🥗", image: "/category-assets/chilled-food.png", matchText: "อาหารแช่เย็น" },
...
export function normalizePosCategories(categories) {
  ...
  return DEFAULT_POS_CATEGORIES.map((category) => {
    ...
    return {
      ...
      image: Object.prototype.hasOwnProperty.call(saved, "image") ? saved.image : category.image,
    };
  });
}
